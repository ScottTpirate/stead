...
COMPLETED_PHASE_ONE_ISSUE_IDS = %w[STEAD-P1-001 STEAD-P1-016].freeze
IN_PROGRESS_PHASE_ONE_ISSUE_IDS = %w[STEAD-P1-015].freeze
COMPLETED_PHASE_ONE_STATUS = "COMPLETED_PHASE_1"
IN_PROGRESS_PHASE_ONE_STATUS = "IMPLEMENTATION_IN_PROGRESS"
...
if VALID_GATE_STATES.include?(gate_state)
  expected_issue_status = lambda do |issue|
    ...
    elsif COMPLETED_PHASE_ONE_ISSUE_IDS.include?(issue["id"])
      COMPLETED_PHASE_ONE_STATUS
    elsif IN_PROGRESS_PHASE_ONE_ISSUE_IDS.include?(issue["id"])
      IN_PROGRESS_PHASE_ONE_STATUS
