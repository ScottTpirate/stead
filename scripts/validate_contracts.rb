...
EXPECTED_EVENT_CATALOG = {
  ...
  "authorizationEvents" => %w[stead.authorization.model_activated.v1 stead.authorization.tuple_changed.v1 stead.authorization.delegation_revoked.v1 stead.authorization.policy_activated.v1 stead.authorization.effect_changed.v1],
