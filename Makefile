...
foundation-check: go-check contract-check
	scripts/run_pinned_node.sh node --test scripts/checkpoint_a_smoke.test.mjs scripts/checkpoint_a_denial.test.mjs scripts/checkpoint_a_browser.test.mjs scripts/checkpoint_a_tls.test.mjs scripts/checkpoint_a_followon.test.mjs
