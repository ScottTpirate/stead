...
| 5 | STEAD-P1-007 | WS-07 | ADR-CAND-006, P1-002, P1-006, P1-015, and the early WS-12 config/preflight child under P1-011 (not full P1-011 completion) | Transactional outbox commit with post-response JetStream relay through the WS-02-owned partition/draining port and WS-12-owned versioned deployment config; set-oriented activity/inbox; one aggregate composed-read audit |
