...
| 3 | STEAD-P1-017 | WS-11 | GATE-P0-APPROVED, P1-001, P1-015, and accepted ADR-CAND-002 | Materialize only the WS-11 `migration` namespace, deployment-qualified roles, deny-by-default ACLs, and owner ledger through the generic migration harness; no importer, cutover, provider-sync, aggregate runner, backup, or restore ownership |
...
| 5 | STEAD-P1-003 | WS-03 | accepted ADR-CAND-008 at an exact immutable SHA with project-owner approval, P1-002, P1-006 | Stock Gitea adapter, hidden tracker/board, provider-neutral Work backing, docs Git, and local rebuildable provider projection; closed accept/reset/quarantine reconciliation with one bounded internal read scope, per-effect durable permits outside it, no general code repo, and no ordinary-read provider waterfall |
| 5 | STEAD-P1-010 | WS-10 | P1-002, P1-006 | Filesystem BlobStore and authorized attachment path |
| 5 | STEAD-P1-007 | WS-07 | ADR-CAND-006, P1-002, P1-006, the P1-015 provider-neutral recovery port, and the early WS-12 development-stack/config child under P1-011 (not full P1-011 completion) | WS-07-owned registry semantics and post-response JetStream relay; stable per-generation message ID; leader-served exact read-back for duplicate acknowledgements; fenced new-generation recovery for a missing copy; retained PostgreSQL source until consumer-owned outcomes complete; set-oriented activity/inbox and one aggregate composed-read audit |
...
| 11 | STEAD-P1-011 | WS-12 | P1-001…010, P1-013…017 | One-command local install, OTel/health/doctor, policy activation operations, and backup/restore baseline |
| 12 | STEAD-P1-012 | WS-13 | P1-001…011, P1-013…017 | Independently gate TEST-009 before TEST-010; standard performance/call-count evidence; request-boundary security; strict seam; policy activation, bypass, restore and upgrade |
