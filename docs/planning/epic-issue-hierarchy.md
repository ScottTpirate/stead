...
| 5 | STEAD-P1-003 | WS-03 | ADR-CAND-008, P1-002, P1-006 | Stock Gitea adapter, hidden tracker/board, provider-neutral Work backing, docs Git, and local rebuildable provider projection; closed accept/reset/quarantine reconciliation with no general code repo or ordinary-read provider waterfall |
