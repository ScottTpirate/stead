...
| 5 | STEAD-P1-007 | WS-07 | ADR-CAND-006, P1-002, P1-006, P1-015, and the early WS-12 development-stack/config child under P1-011 (not full P1-011 completion) | Transactional outbox commit with post-response JetStream relay through the WS-02-owned outbox port, retained recovery across broker expiry until required consumer outcomes, and WS-12-owned deployment-domain account/two-stream configuration; set-oriented activity/inbox; one aggregate composed-read audit |
