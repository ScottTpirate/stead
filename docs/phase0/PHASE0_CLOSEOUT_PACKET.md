...
- [Policy-decision input](../../policies/policy-decision/input-v0.1.schema.json), [output](../../policies/policy-decision/output-v0.1.schema.json), and [decision table](../../policies/policy-decision/decision-table.yaml) specify deny-by-default, label/context/capability policy and the six-way future-agent intersection.
