...
| Proposed | [ADR-0008: NATS stream, subject, retention, replay, ordering, and dead-letter contract](./0008-nats-stream-subject-retention-replay-ordering-and-dlq.md), proposed for `ADR-CAND-006`; it remains blocking until accepted at an immutable revision with the required non-author reviews. |
| Rejected | None. |
