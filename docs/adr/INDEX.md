...
| Rejected | None. |
| Deferred | `ADR-CAND-002` and `ADR-CAND-008`–`ADR-CAND-020` in [unresolved-implementation-choices.md](./unresolved-implementation-choices.md), each with a decision owner, reviewers, fixed constraints, and a deadline before dependent implementation. |
