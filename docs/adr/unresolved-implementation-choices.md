...
| `ADR-CAND-007` Policy-bundle distribution and trust roots | [ADR-0006](./0006-signed-policy-bundle-distribution-and-activation.md) selects the Stead Policy Activation Set v1, reproducible unsigned content, DSSE/P-256 signing, deployment-policy-driven thresholds/custody/cryptographic assurance, offline trust rotation, and atomic OpenFGA/policy activation; TUF is considered but is not the v1 activation authority. | Pending explicit project-owner approval of the signing-format and controlled activation contracts after required reviews. |
