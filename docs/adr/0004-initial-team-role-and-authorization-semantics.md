...
- `member`: a principal that belongs to the Team and participates in its Team-scoped work and knowledge;
...
Project `owning_team` and `contributing_team` remain accountability/default-policy-target relationships only. A Team lead, member, contributor, ancestor, or descendant receives no Project, Work Item, Document, repository, Code, Delivery, search, count, activity, notification, or navigation access merely from those links. Conversely, a Project role does not create a Team role.
...
| `T-ADR-0004-PERMISSION-MATRIX` | OpenFGA/model mutation | Lead receives viewer/editor plus profile/role management without requiring Organization editor; member receives viewer/editor and contributor viewer only; direct viewer/editor remain explicit; hierarchy/reparent and lead recovery require Organization editor and are denied to lead alone; every Team-management action additionally requires an active acting User; permissive matrix/type mutations fail. |
...
| `T-ADR-0004-ACCOUNTABILITY-NON-GRANT` | OpenFGA/golden | Owning/contributing Team and responsible-Team links grant no Project, Work, Docs, Code, Delivery, count, or activity access. |
...
These tests supply evidence for `T-PRIN-015-ACCEPTANCE`, `T-DOM-009-ACCEPTANCE`, `T-AUTH-002-ACCEPTANCE`, `T-AUTH-003-ACCEPTANCE`, `T-AUTH-006-ACCEPTANCE`, `T-CLS-006-ACCEPTANCE`, `T-UX-006-ACCEPTANCE`, `T-UX-007-ACCEPTANCE`, `T-AGENT-003-ACCEPTANCE`, `T-SEC-006-ACCEPTANCE`, `T-TM-F029-CONTROL`, `SEC-BYP-036`, and `SEC-BYP-043`. Golden coverage must include a non-development Team with Team Docs and a software Team/Project, Directory Group membership, direct contribution, a reparent, an owning/contributing Team link, an Agent member with missing runtime/task authority, and positive/negative role revocation. Neither scenario may expose a developer capability or resource solely because of a Team role.
