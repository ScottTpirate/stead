...
- platform, database/schema, OpenFGA model, policy-decision bundle, every active label profile/version, profile-qualified deployment ceiling, deployment security-domain/assurance policy, OpenAPI/AsyncAPI/schema, Gitea/provider, browser, Kubernetes/Helm/Compose and fixture versions;
