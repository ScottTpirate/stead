...
| `ADR-CAND-007` | `STEAD-P1-006` becomes active | `STEAD-P1-006`, `STEAD-P1-011`, `STEAD-P2-004`, `STEAD-P2-010` | Bundle distribution, trust roots, offline verification, activation, and rollback precede executable classification policy. |
